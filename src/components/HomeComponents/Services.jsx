      ...
      <div className="container px-5 py-24 mx-auto">
        ...
        <div className="services-container flex flex-wrap justify-center items-center gap-4 ">
          {myServices.map((service) => (
            <div className="services-card h-72  cursor-pointer transition-all ease-linear duration-150 w-full  rounded-md px-4 py-6  flex flex-col text-center items-center">
