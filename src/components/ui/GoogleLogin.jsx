...
function GoogleLogin() {
  const { theme, mainColor, textColor, bgColor } = useTheme();
  ...
  return (
    <>
      <div className="relative w-full z-10 text-center bg-yellow-500 my-7 mb-10">
        <p
          style={{
            // color: `${theme === "black" ? "white" : "#9ca3af"}`,
            backgroundColor: `${theme === "black" ? "black" : "white"}`,
          }}
          className="font-bold text-gray-400 cursor-pointer absolute  left-[50%] -translate-x-[50%] top-[50%] -translate-y-[50%] bg-white px-3"
        >
          Or Login With
        </p>
