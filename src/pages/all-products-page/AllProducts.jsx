      ...
      >
        ...
        <div className="container  px-3 py-24 mx-auto">
          ...
          <div className="flex relative">
            ...
            {/* CONTENT CONTAINER */}
            <div className="all-products-container flex w-full gap-4 flex-wrap ">
              {/* CARD */}
              {products.length != 0 ? (
                products?.map((data) => {
                  return (
                    <div
                      key={data?.id}
                      className="all-products-card flex flex-col"
                    >
                      {/* CARD IMAGE */}
                      <Image
                        height={"20rem"}
                      ...
                      <div className="cart-content p-6 flex flex-col ">
                        ...
                        <h3 className="brand tracking-widest text-indigo-500 font-medium title-font">
                          {data.brand ? data.brand : "Not Mentioned"}
                        </h3>
                        {/* TITLE */}
                        <h2
                          style={{
                ...
                <StatusMessage
                  status={"404"}
                  title={"404 Not Found"}
                  subTitle={`Sorry, no items matched your search for "${searchQuery}"`}
                  onClick={() => navigate("/")}
                  btnTxt={"Back Home"}
                />
              )}
